...
const App: React.FC = () => {
  document.title = 'PayStream Admin v2.2.92 (FIXED)';
    ...
    return (
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-center text-gray-500 text-xs mt-8">Admin v2.2.92-MySQL &copy; 2025 PayStream. All rights reserved.</p>
        </div>
      </div>
    );
  }
